...
insert  into `user_details`(`user_oid`,`email_id`,`screen_name`,`session_name`,`role`) values (2,'murthy.koppu@imaginea.com','Murthy','https://www.google.com/accounts/o8/id?id=AItOawm-9nOyl-cbsMal3DmxRZdJzsTxB2RAFUQ','ROLE_STUDENT');
